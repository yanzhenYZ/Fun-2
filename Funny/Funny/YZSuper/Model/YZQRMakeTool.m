...
@implementation YZQRMakeTool

+ (UIImage *)makeQRWithString:(NSString *)string{
    //二维码滤镜
    ...
    UIImage * imageQR = [self imageBlackToTransparent:image withRed:0 andGreen:99 andBlue:251];
    return imageQR;
}
